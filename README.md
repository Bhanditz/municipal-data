...
Go to [National Treasury Local Government Database](https://lg.treasury.gov.za/iworld/default_prov.htm)
...
This excel file will be processed by the audit_opinions.py file
...
For Contact Details
	...
	- Process Request: The downloaded file has .xls extension but is html - open in libreoffice or excel and save explicitly as .xls again.
This excel file will be processed by contact_details.py file
